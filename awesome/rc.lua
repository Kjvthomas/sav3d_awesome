...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "n", function () awful.util.spawn( "/home/sav3d/Applications/Nextcloud-3.3.1-x86_64_332d890d59fed28c70f0e58f2a1b04f3.AppImage" ) end,
        {description = "Nextcloud", group = "super"}),
    awful.key({ modkey }, "w", function () awful.util.spawn( "browser1" ) end,
        {description = "librewolf", group = "super"}),
    awful.key({ modkey }, "e", function () awful.util.spawn( editorgui ) end,
        {description = "run atom", group = "super"}),
    awful.key({ modkey }, "h", function () awful.util.spawn( "urxvt -T 'bpytop' -e bpytop" ) end,
        {description = "bpytop", group = "super"}),
        awful.key({ modkey }, "i", function () awful.util.spawn( "inkscape" ) end,
            {description = "inkscape", group = "super"}),
        awful.key({ modkey }, "g", function () awful.util.spawn( "gimp" ) end,
            {description = "gimp", group = "super"}),
    awful.key({ modkey }, "l", function () awful.util.spawn( "libreoffice" ) end,
        {description = "libreoffice", group = "super"}),

    awful.key({ modkey }, "r", function () awful.util.spawn( "dwall -s earth" ) end,
        {description = "wallpaper refresher", group = "super"}),
    ...
    awful.key({ modkey, "Shift"   }, "Return", function() awful.util.spawn( filemanager ) end,
        {description = "file manager", group = "super"}),
    ...
    awful.key({ modkey1, altkey   }, "c", function() awful.util.spawn("galculator") end,
        {description = "galculator", group = "alt+ctrl"}),
